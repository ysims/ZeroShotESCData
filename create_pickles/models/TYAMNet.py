...
class TYAMNet(nn.Module):
    def __init__(self, channels=1, num_classes=40, nhead=2, num_encoder_layers=1, dim_feedforward=128):
        super().__init__()
        self.name = "TYAMNet"
        net_configs = [
        ...
        # Transformer encoder layer (added)
        encoder_layers = TransformerEncoderLayer(d_model=input_dim, nhead=nhead, dim_feedforward=output_dim)
